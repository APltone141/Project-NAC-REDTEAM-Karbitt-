...
Dalam tantangan ini, mekanisme pengubahan nama user menjadi target eksploitasi. Peserta diminta untuk mengubah nama tanpa berinteraksi langsung dengan platform utama.
...
Berdasarkan temuan pada mekanisme POST, dibuat sebuah form HTML mandiri yang mensimulasikan request tersebut. Form ini dirancang agar dapat mengirimkan data ke server target dari "tanah asing".
...
Pada percobaan pertama, serangan menghasilkan true negative, di mana metode sudah benar namun flag tidak muncul. Hal ini disebabkan oleh proteksi platform yang melakukan pengecekan terhadap header **Origin**.

Ditemukan bahwa Request harus berasal dari origin yang telah ditentukan oleh platform.
...
## (7f2af07e0e0ac2c54e8ae0665b4aa68762ba63af)
![Flag](./flag/csrf.png)
![Flag](./flag/csrf-proof-1.png)
![Flag](./flag/csrf-proof-2.png)
